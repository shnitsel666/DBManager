namespace DatabaseManager
{
    ...
    public partial class DBManager : IDisposable
    {
        ...
        public async Task<int> InsertModelAsync(object model, bool getIdentity)
        {
            ...
            {
                throw new DataManagerException($"У типа {modelType.FullName} должен стоять атрибут [Table]");
            }
        ...
        public async Task<int> UpdateModelAsync(object model)
        {
            ...
            {
                throw new DataManagerException($"Для обновления типа {modelType.FullName} одно из его свойств должно иметь атрибут [PrimaryKey]");
            }
